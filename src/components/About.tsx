                ...
                >
                    ...
                    <div className='glass-card shadow-card rounded-xl md:rounded-2xl p-6 sm:p-8 mb-6 md:mb-8 border border-primary/20'>
                        <p className='text-base sm:text-lg text-muted-foreground leading-relaxed mb-4 md:mb-6'>
                            ...
                            tecnológicas que fazem a diferença. Minha jornada no desenvolvimento web
                            começou com curiosidade e evoluiu para uma dedicação profunda em
                            construir aplicações robustas, escaláveis e de fácil manutenção.
                        </p>
                        <p className='text-base sm:text-lg text-muted-foreground leading-relaxed'>
                            Acredito fortemente em práticas de Código Limpo, desenvolvimento
                            orientado a testes e automação de processos. Meu objetivo é não apenas
                            escrever código que funciona, mas código que pode ser facilmente
                            compreendido, mantido e expandido por toda a equipe.
                        </p>
                    </div>
