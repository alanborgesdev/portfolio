...
const AboutSection = () => {
    ...
    return (
        <section id='sobre' className='bg-gray-900 text-white py-20'>
                ...
                <div className='flex flex-col md:flex-row items-center gap-12'>
                    ...
                    >
                        <img
                            src={Avatar}
                            alt='Seu Nome'
                            className='rounded-full w-full h-full object-cover shadow-lg border-4 border-gray-700'
                        />
                    </motion.div>
                    ...
                    >
                        ...
                        <div className='flex flex-wrap gap-3'>
                            {technologies.map((tech) => (
                                <span
                                    key={tech}
                                    className='bg-gray-800 text-blue-400 font-medium px-4 py-2 rounded-lg shadow-sm'
                                >
                                    {tech}
                                </span>
                            ))}
