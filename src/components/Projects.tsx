...
// IMPORTS CORRIGIDOS (Apenas os arquivos originais)
// Renomeei os vídeos para evitar confusão com o sufixo "Img"
import pokedexVideo from '@/assets/project-pokedex.mp4';
import newsletterVideo from '@/assets/project-newsletter.mp4';
import movieflixImg from '@/assets/project-movieflix.webp'; // Imagem
import botflixVideo from '@/assets/project-botflix.mp4';
import landingImg from '@/assets/project-landing.webp'; // Imagem
