                ...
                <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center">
                    ...
                    >
                        ...
                        <div className="font-mono text-base sm:text-lg mb-6 md:mb-8 text-left max-w-lg mx-auto md:mx-0">
                            ...
                            <p className="text-muted-foreground mb-2">
                                <span className="text-accent">{'>'}</span> specialties: [
                                <span className="text-primary"> "Componentização com React"</span>,{' '}
                                <span className="text-primary">"UI Responsiva"</span>,{' '}
                                <span className="text-primary">"Consumo de APIs REST"</span> ]
                            </p>
